...
public class LoadBCPointerOpCodeTest
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	@Test
	public void testLD_BCPointerA()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0x02 );
		...
		// (BC) should contain the value of A
		int bcPointerVal = this.memory.read8( 0x4243 );
		Assert.assertEquals( 'A', bcPointerVal );
	}	
	//----------------------------------------------------------
	//                     STATIC METHODS
	//----------------------------------------------------------
