...
public class LoadDEPointerOpCodeTest
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	@Test
	public void testLD_DEPointerA()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0x12 );
		...
		// (DE) should contain the value of A
		int dePointerVal = this.memory.read8( 0x4445 );
		Assert.assertEquals( 'A', dePointerVal );
	}	
	//----------------------------------------------------------
	//                     STATIC METHODS
	//----------------------------------------------------------
