...
public class LoadIYOpCodeTest
{
	...
	public void testLD_IXWord()
	{
		...
		// IY should contain the value of the word param
		Assert.assertEquals( 0xCAFE, this.registers.getIY() );
	}
	
	@Test
	public void testLD_IYWordPointer()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0xFD );
		...
		// IY should contain the value that the word param pointed to
		Assert.assertEquals( 0x1337, this.registers.getIY() );
	}
