...
public class LoadHLOpCodeTest
{
	...
	public void setUp()
	{
		...
		this.memory.write8( 0x4545, 0x37 );
		this.memory.write8( 0x4546, 0xA1 );
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	@Test
	public void testLD_HLWordPointer()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0x2A );
		memory.write16( BASE_PC + 1, 0x4545 );
		...
		// HL should contain the value that the word param pointed to
		Assert.assertEquals( 0xA137, this.registers.getHL() );
	}
	
	@Test
	public void testLD_HLWordPointer2()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0xED );
		memory.write8( BASE_PC + 1, 0x6B );
		...
		// HL should contain the value that the word param pointed to
		Assert.assertEquals( 0x1337, this.registers.getHL() );
	}
