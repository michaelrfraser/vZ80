...
public class LoadBCOpCodeTest
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	@Test
	public void testLD_BCWord()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0x01 );
		...
		// BC should contain the value of the word param
		Assert.assertEquals( 0xCAFE, this.registers.getBC() );
	}
	
	@Test
	public void testLD_BCWordPointer()
	{
		// Set the opcode as the first instruction in memory
		memory.write8( BASE_PC, 0xED );
		memory.write8( BASE_PC + 1, 0x4B );
		...
		Assert.assertEquals( 0x1337, this.registers.getBC() );
	}
