...
public class LoadBTest
{
	...
	public void testLoadB_A()
	{
		...
		IInstruction load = new Load8bit( B.instance, A.instance );
		load.execute( vm );
	...
	public void testLoadB_B()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, B.instance );
		load.execute( vm );
	...
	public void testLoadB_C()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, C.instance );
		load.execute( vm );
	...
	public void testLoadB_D()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, D.instance );
		load.execute( vm );
	...
	public void testLoadB_E()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, E.instance );
		load.execute( vm );
	...
	public void testLoadB_H()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, H.instance );
		load.execute( vm );
	...
	public void testLoadB_L()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, L.instance );
		load.execute( vm );
	...
	@Test
	public void testLoadB_HLPointer()
	{
		VirtualMachine vm = new VirtualMachine();
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, HLPointer.instance );
		load.execute( vm );
	...
	@Test
	public void testLoadB_BCPointer()
	{
		VirtualMachine vm = new VirtualMachine();
		Memory ram = vm.getRam();
		RegisterFile reg = vm.getRegisters();
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, BCPointer.instance );
		load.execute( vm );
	...
	@Test
	public void testLoadB_DEPointer()
	{
		VirtualMachine vm = new VirtualMachine();
		Memory ram = vm.getRam();
		RegisterFile reg = vm.getRegisters();
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, DEPointer.instance );
		load.execute( vm );
	...
	public void testLoadB_Pointer()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, new Pointer(0x0FF0) );
		load.execute( vm );
	...
	@Test
	public void testLoadB_IXPointer()
	{
		VirtualMachine vm = new VirtualMachine();
		Memory ram = vm.getRam();
		RegisterFile reg = vm.getRegisters();
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, new IXPointer(5) );
		load.execute( vm );
	...
	@Test
	public void testLoadB_IYPointer()
	{
		VirtualMachine vm = new VirtualMachine();
		Memory ram = vm.getRam();
		RegisterFile reg = vm.getRegisters();
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, new IYPointer(3) );
		load.execute( vm );
	...
	public void testLoadB_Value()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load8bit( B.instance, 0xF0 );
		load.execute( vm );
