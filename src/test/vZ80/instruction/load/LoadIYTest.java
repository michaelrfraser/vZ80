...
public class LoadIYTest
{
	...
	//----------------------------------------------------------
	@Test
	public void testLoadIY_Value()
	{
		VirtualMachine vm = new VirtualMachine();
		RegisterFile reg = vm.getRegisters();
		
		// Create and execute the load instruction
		IInstruction load = new Load16bit( IY.instance, 0x0FF0 );
		load.execute( vm );
	...
	public void testLoadHL_Pointer()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load16bit( IY.instance, new Pointer(0x0FF0) );
		load.execute( vm );
