...
import vZ80.instruction.stack.Push;
...
public class PushTest
{
	...
	public void testPushAF()
	{
		...
		Assert.assertEquals( 0x0F, ram.get(baseSP - 1) );
		Assert.assertEquals( 0xF0, ram.get(baseSP - 2) );
		Assert.assertEquals( 0x0A, ram.get(baseSP - 3) );
		Assert.assertEquals( 0xA0, ram.get(baseSP - 4) );
	}
