...
public class LoadETest
{
	...
	public void testLoadE_A()
	{
		...
		IInstruction load = new Load( E.instance, A.instance );
		load.execute( vm );
	...
	public void testLoadE_B()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, B.instance );
		load.execute( vm );
	...
	public void testLoadE_C()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, C.instance );
		load.execute( vm );
	...
	public void testLoadE_D()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, D.instance );
		load.execute( vm );
	...
	public void testLoadE_E()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, E.instance );
		load.execute( vm );
	...
	public void testLoadE_H()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, H.instance );
		load.execute( vm );
	...
	public void testLoadE_L()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, L.instance );
		load.execute( vm );
	...
	public void testLoadE_HLptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, HLPtr.instance );
		load.execute( vm );
	...
	public void testLoadE_BCptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, BCPtr.instance );
		load.execute( vm );
	...
	public void testLoadE_DEptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, DEPtr.instance );
		load.execute( vm );
	...
	public void testLoadE_Wordptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, new WordPtr(0x0FF0) );
		load.execute( vm );
	...
	public void testLoadE_IXptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, new IXPtr(5) );
		load.execute( vm );
	...
	public void testLoadE_IYptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, new IYPtr(3) );
		load.execute( vm );
	...
	public void testLoadE_Value()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( E.instance, new ByteValue(0xF0) );
		load.execute( vm );
