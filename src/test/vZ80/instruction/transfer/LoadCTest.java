...
public class LoadCTest
{
	...
	public void testLoadC_A()
	{
		...
		IInstruction load = new Load( C.instance, A.instance );
		load.execute( vm );
	...
	public void testLoadC_B()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, B.instance );
		load.execute( vm );
	...
	public void testLoadC_C()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, C.instance );
		load.execute( vm );
	...
	public void testLoadC_D()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, D.instance );
		load.execute( vm );
	...
	public void testLoadC_E()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, E.instance );
		load.execute( vm );
	...
	public void testLoadC_H()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, H.instance );
		load.execute( vm );
	...
	public void testLoadC_L()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, L.instance );
		load.execute( vm );
	...
	public void testLoadC_HLptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, HLPtr.instance );
		load.execute( vm );
	...
	public void testLoadC_BCptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, BCPtr.instance );
		load.execute( vm );
	...
	public void testLoadC_DEptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, DEPtr.instance );
		load.execute( vm );
	...
	public void testLoadC_Wordptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, new WordPtr(0x0FF0) );
		load.execute( vm );
	...
	public void testLoadC_IXptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, new IXPtr(5) );
		load.execute( vm );
	...
	public void testLoadC_IYptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, new IYPtr(3) );
		load.execute( vm );
	...
	public void testLoadC_Value()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( C.instance, new ByteValue(0xF0) );
		load.execute( vm );
