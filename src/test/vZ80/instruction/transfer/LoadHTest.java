...
public class LoadHTest
{
	...
	public void testLoadH_A()
	{
		...
		IInstruction load = new Load( H.instance, A.instance );
		load.execute( vm );
	...
	public void testLoadH_B()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, B.instance );
		load.execute( vm );
	...
	public void testLoadH_C()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, C.instance );
		load.execute( vm );
	...
	public void testLoadH_D()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, D.instance );
		load.execute( vm );
	...
	public void testLoadH_E()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, E.instance );
		load.execute( vm );
	...
	public void testLoadH_H()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, H.instance );
		load.execute( vm );
	...
	public void testLoadH_L()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, L.instance );
		load.execute( vm );
	...
	public void testLoadH_HLptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, HLPtr.instance );
		load.execute( vm );
	...
	public void testLoadH_BCptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, BCPtr.instance );
		load.execute( vm );
	...
	public void testLoadH_DEptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, DEPtr.instance );
		load.execute( vm );
	...
	public void testLoadH_Wordptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, new WordPtr(0x0FF0) );
		load.execute( vm );
	...
	public void testLoadH_IXptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, new IXPtr(5) );
		load.execute( vm );
	...
	public void testLoadH_IYptr()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, new IYPtr(3) );
		load.execute( vm );
	...
	public void testLoadH_Value()
	{
		...
		// Create and execute the load instruction
		IInstruction load = new Load( H.instance, new ByteValue(0xF0) );
		load.execute( vm );
